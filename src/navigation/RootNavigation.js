  ...
  return (
    <NavigationContainer>
      <Stack.Navigator initialRouteName={navigationStrings.drawerMainPage}>
        ...
        />
        <Stack.Screen
          name={navigationStrings.Example}
          component={Screens.Example}
          options={{ headerShown: false }}
        />
        <Stack.Screen
          name={navigationStrings.SettingsPage}
        ...
        <Stack.Screen
          ...
          options={{ headerShown: false }}
          component={container.QrScanner}
        />
        <Stack.Screen
          name={navigationStrings.drawerMainPage}
          options={{ headerShown: false }}
          component={App}
        />
      </Stack.Navigator>
